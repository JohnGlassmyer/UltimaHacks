; =============================================================================
; Ultima VII: Serpent Isle Hacks -- expanded overlay 1
; -----------------------------------------------------------------------------
...
eopProc eop1, 0x110, keepMoving
eopProc eop1, 0x2C0, keyActions
...
eopProc eop1, 0x0B0, selectAndUseKey
eopProc eop1, 0x120, shapeBark
eopProc eop1, 0x0F0, shapeBarkForContent
eopProc eop1, 0x050, target
eopProc eop1, 0x080, toggleAudio
eopProc eop1, 0x080, toggleCheats
eopProc eop1, 0x030, toggleCombat
eopProc eop1, 0x050, toggleMouseHand
