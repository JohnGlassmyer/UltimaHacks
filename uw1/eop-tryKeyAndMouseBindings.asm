...
startPatch EXE_LENGTH, \
	...
	startBlockAt addr_eop_tryKeyAndMouseBindings
		push bp
		mov bp, sp
		...
		mov word [dseg_pn_lastKeyOrMouseBinding], 0
		mov si, 1
		tryBindingsLoop:
