...
startPatch EXPANDED_OVERLAY_U7_EXE_LENGTH, \
        expanded overlay procedure: castByKey
        
    ; taking 4 bytes occupied by Borland copyright text
    ; to store pointer to persistent heap-allocated castByKey data
    startBlockAt off_dseg_segmentZero + dseg_castByKeyDataAddress
        dd 0
    endBlock
    
    startBlockAt off_eop_castByKey
        push bp
        mov bp, sp
        ...
        ; allocate memory and save the address for future calls
            ...
            callWithRelocation o_allocateVoodooMemory
            add sp, 6
        ...
        ; now try to find a spellbook having the matched spell
            ...
            forSpellbookInList:
                ...
                callWithRelocation o_list_stepForward
                add sp, 4
                ...
                push ax
                callWithRelocation o_doesSpellbookHaveSpell
                add sp, 4
            ...
            push word [bp+var_spellbookList]
            callWithRelocation o_list_removeAndDestroyAll
            callWithRelocation o_deallocateNearMemory
            pop cx
            ...
            ; fail if avatar cannot cast the spell
                ...
                push word [bp+var_spellNumber]
                push dseg_avatarIbo
                callWithRelocation o_canCastSpell
                add sp, 8
                test ax, ax
                jz canNotCast
            ...
            ; try to cast the spell (checks mana and reagents)
                ...
                push word [bp+var_spellNumber]
                push dseg_avatarIbo
                callWithRelocation o_tryToCastSpell
                add sp, 10
