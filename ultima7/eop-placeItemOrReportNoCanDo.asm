...
startPatch EXE_LENGTH, \
		eop-placeItemOrReportNoCanDo
		
	startBlockAt seg_eop, off_eop_placeItemOrReportNoCanDo
		push bp
		mov bp, sp
		...
		push ax
		callFromOverlay getItemXCoordinate
		add sp, 6
		...
		push ax
		callFromOverlay getItemYCoordinate
		add sp, 6
		...
		; move was successful
			...
			lea ax, [bp+var_itemIbo]
			push ax
			callFromOverlay reactToItemMovement
			add sp, 6
